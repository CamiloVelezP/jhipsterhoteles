...
import com.arquisocios.reserva.service.HotelService;
...
/**
 * REST controller for managing {@link com.arquisocios.reserva.domain.Hotel}.
 */
@RestController
@RequestMapping("/api")
public class HotelResource {
    ...
    private static final String ENTITY_NAME = "reservaHotel";
     ...
     */
    @GetMapping("/hotels")
    public ResponseEntity<List<Hotel>> getAllHotels(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
