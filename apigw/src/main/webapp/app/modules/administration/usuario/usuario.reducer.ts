...
const adminUrl = 'api/admin/usuarios';
// Actions
...
export const createEntity = createAsyncThunk(
  ...
  async (entity: IUsuario, thunkAPI) => {
    const result = await axios.post<IUsuario>(adminUrl, cleanEntity(entity));
...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: IUsuario, thunkAPI) => {
    const result = await axios.put<IUsuario>(`${adminUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IUsuario, thunkAPI) => {
    const result = await axios.patch<IUsuario>(`${adminUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
