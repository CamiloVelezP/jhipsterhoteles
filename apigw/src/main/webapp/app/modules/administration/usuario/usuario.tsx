...
export const Usuario = () => {
  ...
  const usuarioList = useAppSelector(state => state.apigw.usuario.entities);
  const loading = useAppSelector(state => state.apigw.usuario.loading);
  const totalItems = useAppSelector(state => state.apigw.usuario.totalItems);
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('nroDoc')}>
