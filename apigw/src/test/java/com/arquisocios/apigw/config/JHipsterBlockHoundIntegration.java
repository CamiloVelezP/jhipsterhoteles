...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.arquisocios.apigw.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.arquisocios.apigw.security.DomainUserDetailsService", "createSpringSecurityUser");
